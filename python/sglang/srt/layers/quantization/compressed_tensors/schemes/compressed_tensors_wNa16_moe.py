...
class CompressedTensorsWNA16MoEAscendMethod(CompressedTensorsWNA16MoE):
    def __init__(self, quant_config: CompressedTensorsConfig, num_gpu_experts=-1):
    ...
    def custom_moe(
        ...
        **kwargs,
        ...
        if hidden_states.shape[0] == 1:
            final_hidden_states = custom_ops_qujing.npu_moe_ffn(
                hidden_states,
                w13, w13_scale,
                w2, w2_scale,
                topk_ids.view(-1),
    ...
    def apply_without_routing_weights(
        ...
        hidden_states = custom_ops_qujing.npu_moe_without_routing_ffn(
            hidden_states,
